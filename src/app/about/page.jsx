...
export default function AboutPage() {
  return (
    <div className=" mt-10 object-contain" style={{ backgroundImage: "url('/low-poly-grid-haikei.svg')" } }>
      {/* هیرو بخش */}
      ...
      {/* داستان ما */}
      <section className="w-full mx-auto px-4 py-16 backdrop-blur-xs">
      ...
      {/* آمار و ارقام */}
      <section className=" text-white py-16 backdrop-blur-xs">
        <div className="max-w-7xl mx-auto px-4">
